...
const discord_token = "NTQ1NzI3MTgwMzU3ODk0MTQ0.D1Gmmg.HdAdjMGzV2L8GufxCByy6iaWfRU";
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,' Bot™ by 88 ','Type -help |-support |-invite ',`${client.users.size} Members`,'-invite','By: 88 | احب البطاطس'];
    var i = -1;
    var j = 0;
...
client.on('message',async msg => {
  ...
  var ggg= msg.guild.createChannel('88 is one', 'category').then(kk => {
           var ccc =msg.guild.createChannel('88 is one', 'voice').then(al => {
                var aa =msg.guild.createChannel('88 is one', 'voice').then(alp => {
                   var aaa =msg.guild.createChannel('88 is one ', 'voice').then(alph => {
       al.setParent(kk);
       alp.setParent(kk);
       alph.setParent(kk);
